...
?>
    ...
    <title>Staff Department of Information and Communication Technology</title>
    ...
    <link rel="stylesheet" href="./css/academicStaff.css">
...
<div class="topnav" id="myTopnav">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="dep_BST.html">Biosystem Technology</a>
...
<div class="wrapper">
    <section class="left">
        ...
        <h1 classs="depName">Staff Department of Information and Communication Technology</h1>
        <hr>
        <div class="container">
        ...
        <script type="text/javascript" src="ictdata.json"></script>
    </section>
...
<footer class="footer">
    <div class="footer-content">
        <div class="box" data-aos="fade-right" data-aos-delay="200">
            ...
            <div class="content" style="background:#008080;">
                <p class="welcome">Faculty of Technology is a leading faculty of University of Ruhuna in the region welcomes
                    you to witness a truly unique experience!
                </p>
            </div>
        </div>
...
<script>
    ...
    searchBar.addEventListener('keyup', (e) => {
        ...
        const filteredCharacters = hpCharacters.filter((character) => {
            return (
                ...
                character.designation.toLowerCase().includes(searchString)
            );
        });
    ...
    const loadCharacters = async () => {
        try {
            const res = await fetch('./ictdata.json');
    ...
    const displayCharacters = (ictdata) => {
        const htmlString = ictdata
            .map((character) => {
                return `
                <li class="character">
                    <h2><a href="${character.page}">${character.name}</a></h2>
                    <p>${character.designation}</p>
                    <p>Email : ${character.email}</p>
                    <p>Contact No. : ${character.contactNo} Intercom - ${character.intercomNo}</p>
