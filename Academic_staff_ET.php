...
<head>
    ...
    <title>Staff Department of Engineering Technology</title>
...
<div class="wrapper">
    <section class="left">
        <h1 classs="depName">Staff Department of Engineering Technology</h1>
        <hr>
        <!-- --------------------------- Timeline --------------------------------------------- -->
        ...
        <script type="text/javascript" src="etdata.json"></script>
    </section>
...
<script>
    ...
    const loadCharacters = async () => {
        try {
            const res = await fetch('etdata.json');
    ...
    const displayCharacters = (etdata) => {
        const htmlString = etdata
            .map((character) => {
                return `
                <li class="character">
